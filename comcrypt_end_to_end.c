...
static uint8_t signal_bytes[543 * 2] = {0};
...
const huffman_codeword huffman_codebook[16] = {{0b1, 1}, {0b00111, 5}, {0b00011, 5}, {0b001100, 6}, {0b000100, 6}, {0b0010001, 7}, {0b0010110, 7}, {0b0010111, 7}, {0b00100001, 8}, {0b001001, 6}, {0b001101, 6}, {0b00000, 5}, {0b000101, 6}, {0b001010, 6}, {0b00001, 5}, {0b01, 2}};

const huffman_codeword huffman_eof = {0b00100000, 8};
...
static int16_t signal[543] = {948, 948, 948, 948, 948, 948, 948, 948, 951, 951, 954, 951, 951, 952,
...
static const int16_t threshhold = 50;
/*---------------------------------------------------------------------------*/
...
PROCESS_THREAD(comcrypt_process, ev, data)
{
  ...
  data_len = COMPRESS.dwt_transform(signal, 128);
  ...
  // COMPRESS.threshold(signal, threshhold, 543 * 2);
  // #if DEBUG
  ...
  // LOG_INFO_("\n");
  // #endif
  h_data = COMPRESS.huffman_encode(signal_bytes, data_len*2, huffman_codebook, huffman_eof);
