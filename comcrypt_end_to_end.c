...
const huffman_codeword huffman_codebook[16] = {
    {0b0, 1}, {0b10011, 5}, {0b1110001, 7}, {0b10001, 5}, {0b111010, 6}, {0b111011, 6}, {0b111001, 6}, {0b10000, 5}, {0b10100, 5}, {0b10111, 5}, {0b1101, 4}, {0b1100, 4}, {0b10110, 5}, {0b10010, 5}, {0b10101, 5}, {0b1111, 4}};
...
// fct_transform(signal);
  ...
  // aes_encrypt_ctr(signal_bytes, iv, BLOCK_LEN, key);
  ...
  for (i = 0; i < CEIL_DIVIDE(BLOCK_LEN, TX_BUFFER_SIZE); i++)
  {
    ...
    // PROCESS_YIELD_UNTIL(ev == PROCESS_EVENT_COM);
  }
